...
namespace VtNetCore.VirtualTerminal
{
    ...
    internal static class KeyboardTranslations
    {
        ...
        /// </summary>
        private static readonly Dictionary<string, KeyboardTranslation> KeyTranslations =
            new Dictionary<string, KeyboardTranslation>
            {
                ...
                {
                    "F5",
                    new KeyboardTranslation { Normal = "\u001b[15~", Shift = "\u001b[28~", Control = "\u001b[15~" }
                },
                {
                    "F6",
                    new KeyboardTranslation { Normal = "\u001b[17~", Shift = "\u001b[29~", Control = "\u001b[17~" }
                },
                {
                    "F7",
                    new KeyboardTranslation { Normal = "\u001b[18~", Shift = "\u001b[31~", Control = "\u001b[18~" }
                },
                {
                    "F8",
                    new KeyboardTranslation { Normal = "\u001b[19~", Shift = "\u001b[32~", Control = "\u001b[19~" }
                },
                {
                    "F9",
                    new KeyboardTranslation { Normal = "\u001b[20~", Shift = "\u001b[33~", Control = "\u001b[20~" }
                },
                {
                    "F10",
                    new KeyboardTranslation { Normal = "\u001b[21~", Shift = "\u001b[24~", Control = "\u001b[21~" }
                },
                {
                    "F11",
                    new KeyboardTranslation { Normal = "\u001b[23~", Shift = "\u001b[23~", Control = "\u001b[23~" }
                },
                {
                    "F12",
                    new KeyboardTranslation { Normal = "\u001b[24~", Shift = "\u001b[24~", Control = "\u001b[24~" }
                },
                ...
                {
                    "Up",
                    new KeyboardTranslation
                        { Normal = "\u001b[A", Shift = "\u001bOA", Control = "\u001bOA", ShiftOnApplication = true }
                },
                {
                    "Down",
                    new KeyboardTranslation
                        { Normal = "\u001b[B", Shift = "\u001bOB", Control = "\u001bOB", ShiftOnApplication = true }
                },
                {
                    "Right",
                    new KeyboardTranslation
                        { Normal = "\u001b[C", Shift = "\u001bOC", Control = "\u001bOC", ShiftOnApplication = true }
                },
                {
                    "Left",
                    new KeyboardTranslation
                        { Normal = "\u001b[D", Shift = "\u001bOD", Control = "\u001bOD", ShiftOnApplication = true }
                },
