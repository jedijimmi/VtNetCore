...
namespace VtNetCore.VirtualTerminal.Model
{
    ...
    public class TerminalLine : List<TerminalCharacter>
    {
        ...
        /// <summary>
        ///     Specifies that the text on this line should contain the top half of a double high/double wide/double spaced
        ///     character
        /// </summary>
        public bool DoubleHeightTop { get; set; } = false;

        /// <summary>
        ///     Specifies that the text on this line should contain the bottom half of a double high/double wide/double spaced
        ///     character
        /// </summary>
